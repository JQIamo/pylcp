...
def Xstate(Lambda, S, N, I1, B, gamma, q, b, c, CI, q0, q2, gS, gI,
    ...
    ----------
        Lambda : int
            :math:`\Lambda` quantum number, the projection of the orbital
            angular momentum on the internuclear axis.
        S : int or float
            :math:`\Sigma` quantum number, the projection of the orbital
            angular momentum on the internuclear axis.
        N : int
...
>>>>>>> Stashed changes
        ...
        muN : float
            Nuclear Magneton.  Default value is the CODATA value in Hz/G
    ...
    :math:`|\\Lambda, N, \\Sigma, J, F, m_F, P \\rangle.`  This has only
    been tested with :math:`N=1` and :math:`\Lambda=0`.
    """
